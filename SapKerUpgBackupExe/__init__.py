...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    logging.info("Command: sudo tar cvf /sapmnt/"+sid+"/exe/uc/linuxx86_64.tar /sapmnt/"+sid+"/exe/uc/linuxx86_64")
    stdin, stdout, stderr = remotecommandclient.exec_command("sudo tar cvf /sapmnt/"+sid+"/exe/uc/linuxx86_64.tar /sapmnt/"+sid+"/exe/uc/linuxx86_64", get_pty=True)
